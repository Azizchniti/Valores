...
export default function BusinessForm() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "url('/image/backgrounds/form-bg.svg')", // 🔹 put your SVG file here
      }}
    >
   <section className="flex flex-col lg:flex-row items-start justify-center gap-12 lg:gap-24">
  {/* Left side - Text section */}
  <div className="mt-16 flex flex-col items-start text-left px-4 lg:px-0">
    <h2
    ...
    <p
      className="text-[#8B949E] font-[TT Commons Pro] font-light mt-4 mb-12"
      style={{
        fontSize: "20px", // bigger
        lineHeight: "1.6",
        maxWidth: "340px", // keeps the paragraph narrow
      }}
    >
