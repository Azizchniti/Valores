      ...
      <section className="relative py-8 px-4 flex items-center justify-center">
        <div className="relative z-10 w-full max-w-3xl rounded-2xl border border-[#58A8AB] bg-[rgba(27,34,42,0.87)] backdrop-blur-md p-6">
          ...
          <form className="flex flex-col gap-3">
            {[
              { placeholder: "Nome", icon: "nome" },
              { placeholder: "Seu melhor e-mail", icon: "email" },
              { placeholder: "Empresa", icon: "empresa" },
              { placeholder: "Cargo", icon: "cargo" },
              { placeholder: "DDD + Whatsapp", icon: "whatsapp" },
              { placeholder: "Qual é o faturamento médio de sua empresa?", icon: "faturamento" },
              { placeholder: "Qual é o segmento de atuação de sua empresa?", icon: "segmento" },
              { placeholder: "Qual a quantidade de colaboradores de sua empresa?", icon: "quantidade" },
            ].map((field, i) => (
              <div
                key={i}
