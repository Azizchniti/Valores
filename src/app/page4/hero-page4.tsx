...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative w-full h-[90vh] overflow-hidden">
      {/* Background */}
      <Image
        src="/image/backgrounds/bgpage4.png"
        alt="Fundo"
        fill
...
>
  <h1 className="text-xl md:text-2xl font-bold text-white leading-snug">
    Seus concorrentes estão usando dados para vender mais. E você?
  </h1>

  <p className="text-[#68778a] text-sm md:text-base font-light leading-relaxed">
      Transformamos dados em sua maior vantagem competitiva. Aumente sua participação no mercado, eleve a rentabilidade e otimize sua operação com a gestão baseada em dados que grandes empresas usam para liderar.  </p>
